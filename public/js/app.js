...
const corePath = typeof process !== 'undefined' && "development" === 'development'
  ? new URL(/* asset import */ Object(function webpackMissingModule() { var e = new Error("Cannot find module '/node_modules/@ffmpeg/core/dist/ffmpeg-core.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), __webpack_require__.b).href
...
const fetchFile = async (_data) => {
  ...
  if (typeof _data === 'string') {
    ...
    /* From remote server/URL */
      ...
      const res = await fetch(new URL(_data, "file:///D:/Ali%20Muhammad%20SSD%20March%202024%20OnWards/Laravel/June%202024/AudioEditor/node_modules/@ffmpeg/ffmpeg/src/browser/fetchFile.js").href);
...
const getCreateFFmpegCore = async ({
  ...
  if (typeof WorkerGlobalScope !== 'undefined' && self instanceof WorkerGlobalScope) {
    ...
    const coreRemotePath = new URL(_corePath, "file:///D:/Ali%20Muhammad%20SSD%20March%202024%20OnWards/Laravel/June%202024/AudioEditor/node_modules/@ffmpeg/ffmpeg/src/browser/getCreateFFmpegCore.js").href;
...
var ffmpeg = await (0,_ffmpeg_ffmpeg__WEBPACK_IMPORTED_MODULE_0__.createFFmpeg)({
  log: true
});
function loadFFmpeg() {
...
function _loadFFmpeg() {
  _loadFFmpeg = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
...
function _readFile() {
  _readFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(file) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          console.log("File ".concat(file.name, " read successfully!"));
          return _context5.abrupt("return", arrayBuffer);
        case 11:
          _context5.prev = 11;
          _context5.t0 = _context5["catch"](0);
          throw new Error("Failed to read file: ".concat(file.name));
        case 14:
        case "end":
...
function displaySelectedFiles(files) {
  var container = document.getElementById('selected-audios');
  container.innerHTML = '';
...
document.getElementById('merge-audio').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var files, i, fileData, inputFiles, data, audioURL, previewElement;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        files = document.getElementById('audio-files').files;
        if (!(files.length < 2)) {
          _context.next = 4;
          break;
        }
      ...
      case 12:
        ...
        console.log("Writing file input".concat(i, ".mp3"));
        ffmpeg.FS('writeFile', "input".concat(i, ".mp3"), new Uint8Array(fileData));
        console.log("File input".concat(i, ".mp3 written successfully!"));
      case 16:
        i++;
        _context.next = 9;
        break;
      case 19:
        inputFiles = files.map(function (_, i) {
          return "input".concat(i, ".mp3");
        }).join('|');
        console.log("Running FFmpeg merge command:", inputFiles);
        _context.next = 23;
        return ffmpeg.run('-i', "concat:".concat(inputFiles), '-c', 'copy', 'output.mp3');
      case 23:
        console.log("FFmpeg merge command completed!");
        data = ffmpeg.FS('readFile', 'output.mp3');
        console.log("Output file read:", data);
        audioURL = URL.createObjectURL(new Blob([data.buffer], {
          type: 'audio/mp3'
        }));
        previewElement = document.getElementById('audio-preview');
      ...
      case 33:
        ...
        alert("An error occurred during merging: ".concat(_context.t0.message));
      case 37:
      case "end":
...
document.getElementById('add-background-music').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var files, fileData, backgroundData, data, audioURL, previewElement;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 12:
        backgroundData = _context2.sent;
        ffmpeg.FS('writeFile', 'input.mp3', new Uint8Array(fileData));
        ffmpeg.FS('writeFile', 'background.mp3', new Uint8Array(backgroundData));
        _context2.next = 17;
        return ffmpeg.run('-i', 'input.mp3', '-i', 'background.mp3', '-filter_complex', '[0:a]volume=1.0[a];[1:a]volume=0.3[b];[a][b]amix=inputs=2:duration=first', 'output_with_music.mp3');
      case 17:
        data = ffmpeg.FS('readFile', 'output_with_music.mp3');
        audioURL = URL.createObjectURL(new Blob([data.buffer], {
          type: 'audio/mp3'
        }));
        previewElement = document.getElementById('audio-preview');
      ...
      case 25:
        ...
        console.error('Add background music error:', _context2.t0);
        alert("An error occurred while adding background music: ".concat(_context2.t0.message));
      case 29:
      case "end":
...
document.getElementById('crop-audio').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var files, startTime, duration, fileData, data, audioURL, previewElement;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      ...
      case 4:
        startTime = prompt('Enter the start time for cropping (in seconds):');
        duration = prompt('Enter the duration for cropping (in seconds):');
      ...
      case 14:
        ...
        ffmpeg.FS('writeFile', 'input.mp3', new Uint8Array(fileData));
        _context3.next = 18;
        return ffmpeg.run('-i', 'input.mp3', '-ss', startTime, '-t', duration, 'output_cropped.mp3');
      case 18:
        data = ffmpeg.FS('readFile', 'output_cropped.mp3');
        audioURL = URL.createObjectURL(new Blob([data.buffer], {
          type: 'audio/mp3'
        }));
        previewElement = document.getElementById('audio-preview');
      ...
      case 26:
        ...
        console.error('Crop error:', _context3.t0);
        alert("An error occurred during cropping: ".concat(_context3.t0.message));
      case 30:
      case "end":
